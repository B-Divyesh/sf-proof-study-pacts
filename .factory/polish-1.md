...
Local evidence: `npm test` passed (2 Rust tests and 20 Playwright tests), including axe checks, privacy request checks, 390 px layout, keyboard, rate limiting, routing, and every claim tag. Deployment and cold-live evidence are recorded in `.factory/handoff.md`.
